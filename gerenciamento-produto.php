...
$sql = "SELECT id, nome, sku, preco, descricao, imagem FROM cadastro_produtos";
...
<head>
    ...
    <style>
        .descricao-produto {
            ...
            padding: 10px; /* Adiciona espaço ao redor da descrição */
            border: 1px solid #ddd; /* Borda sutil */
            border-radius: 4px; /* Bordas arredondadas */
            background-color: #f9f9f9; /* Fundo claro para destacar a descrição */
        }
            ...
            <table>
                ...
                if ($result && $result->num_rows > 0) { // Verifica se $result está definido e tem linhas
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td><img src='" . htmlspecialchars($row['imagem']) . "' class='img-produto' alt='Imagem de " . htmlspecialchars($row['nome']) . "' /></td>";
                        echo "<td>
